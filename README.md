...
Read on for the story behind drone-cache or if you want to jump into action directly, go to the github.
 - [Projects](https://kakkoyun.me/projects/) `March 1, 2020` 
...
Projects Link to heading Cloud-Native Foundation Projects that I help to maintain Link to heading thanos Link to heading Highly available Prometheus setup with long term storage capabilities. CNCF Sandbox project. https://thanos.io
prometheus/client_golang Link to heading Prometheus instrumentation library for Go applications
kube-thanos Link to heading Kubernetes specific configuration for deploying Thanos.
 - [Talks](https://kakkoyun.me/talks/) `March 1, 2020` 
 > This page lists the recorded talks that I have given so far. Not much but it&amp;rsquo;s a start.
For a more up-to-date list, check this YouTube playlist. Link to heading 2022 Link to heading Achieving Zero-Instrumentation Monitoring with eBPF Link to heading Metrics are powerful tools that exist in the cloud-native ecosystem using Prometheus. However, using facilities to enable monitoring requires instrumenting the code. Everyone wants observability, but nobody wants to go the extra mile to instrument their clusters or applications.
 - [Stats](https://kakkoyun.me/stats/) `February 29, 2020` 
 > It is an occupatioanl hazard &lpar;working on observability&rpar; to know how many hours do you spend while doing anything. In this case it is programming.<!-- BLOG-POST-LIST:END -->
